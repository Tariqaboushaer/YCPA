...
c_eps_0 = 8.8542149e-12;          % permittivity in a vacuum 
...
tSim = 200e-15
f = 230e12;
%f = 330e12;   Testing the varying frequency. 
lambda = c_c/f;
...
mu{1} = ones(nx{1},ny{1})*c_mu_0;      % Matrix for vacuum permeability 


% New Inclusion
epi{1}(0:25,55:95)= c_eps_0*11.3;
epi{1}(25:50,55:95)= c_eps_0*11.3;
epi{1}(75:100,55:95)= c_eps_0*11.3;               %Creation of gratings by addition of inclusions
...
% Bound conditions, used for updating the cells in the direction of the
% Waves
bc{1}.NumS = 1;
...
betap = 0;
t0 = 30e-15;
st = -0.05;  %changed from 15e-15 to -0.05
s = 0;
y0 = yMax/2;
sty = 1.5*lambda;
